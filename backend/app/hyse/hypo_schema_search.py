...
def hyse_search(initial_query, search_space=None, num_schema=3, k=10, table_name="tianle", column_name="example_rows_embed"):
...
def hnsw_search(column, search_space, table_name="tianle_column_embeddings", column_name="embedding"):
    logging.info(column)
...
def cos_sim_search(input_embedding, search_space, table_name="tianle", column_name="example_rows_embed"):  
    ...
    with DatabaseConnection() as db:
        ...
        if search_space:
            ...
            query = "SELECT COUNT(*) FROM tianle;"
