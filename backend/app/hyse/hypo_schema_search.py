...
def hyse_search(initial_query, search_space=None, num_schema=3, k=10, table_name="matthew", column_name="example_rows_embed"):
...
def hnsw_search(column, search_space, table_name="matthew_column_embeddings", column_name="embedding"):
    logging.info(column)
...
def cos_sim_search(input_embedding, search_space, table_name="matthew", column_name="example_rows_embed"):  
    ...
    with DatabaseConnection() as db:
        ...
        if search_space:
            ...
            query = "SELECT COUNT(*) FROM matthew;"
...
def aggregate_hyse_search_results(results):
    ...
    for result in flat_results:
        ...
        keywords = ["building data genome", "georgia voter lists", "ohio census data", "costa rica", "life expectancy", "who health indicators"]
